  ...
  const handleFollowClick = async () => {
    ...
    try {
      if (isFollowing) {
        ...
        const updatedUser = {
          ...localUser,
          followers: localUser.followers?.filter(
  ...
  return (
    <div className="w-96 bg-white rounded-lg shadow-md p-4">
      ...
      <div className="flex justify-around mt-4 text-center text-sm">
        ...
        <div>
          <p className="font-bold">{localUser.followersCount || 0}</p>
          <p className="text-gray-500">followers</p>
        </div>
        <div>
          <p className="font-bold">{localUser.followingCount || 0}</p>
